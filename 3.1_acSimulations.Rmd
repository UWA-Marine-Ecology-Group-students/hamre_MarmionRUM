...
# define vars used in RUM
  sz_vars <- dat %>% dplyr::select(num_range("sz", 1:10))
...
# ggsave(path = "./plots/ASC RUM", filename = paste("ac_sim_og.presim.png", sep = ''), width = 8, height = 4)
...
# ggsave(path = "./plots/ASC RUM", filename = paste("ac_sim_og.postsim.png", sep = ''), width = 8, height = 4)
...
# ggsave(diff, path = "./plots/ASC RUM", filename = paste("ac_sim_og.diff.png", sep = ''), width = 8, height = 4)
