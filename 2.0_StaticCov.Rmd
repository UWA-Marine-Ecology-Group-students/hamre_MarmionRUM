...
sites <- st_read("./data/gpkg/Sites_4326.gpkg") %>%  st_transform(4283)# MVM grid
...
```{r fetch}
# waterGrid <- readRDS("./data/gpkg/2.0_espSites_4283.gpkg") # sites with
# 
...
```{r}
waterGrid$shelter <- ifelse(waterGrid$gridID %in% shelter$gridID, 1, 0)
```
