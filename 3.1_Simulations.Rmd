...
dat <- read_csv("./data/02_data/2.1_acdat.csv")
...
# sim <- c('1932', '1933', '1934', '2079', '2080', '2081', '2224', '2225', '2226')
# ntz <- sim
...
# Summaries across draws
    ...
    W_impact_trip
    png("./plots/sim1.W_impact_trip.png", height = 50*nrow(W_impact_trip), width =
